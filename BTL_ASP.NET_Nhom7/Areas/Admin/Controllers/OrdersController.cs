...
namespace BTL_ASP.NET_Nhom7.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,Status,CreateDate,ModifiedDate,UserId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,Status,CreateDate,ModifiedDate,UserId")] Order order)
        {
            if (ModelState.IsValid)
            {
